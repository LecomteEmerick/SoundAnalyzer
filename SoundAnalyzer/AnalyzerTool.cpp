...
void AnalyzerTool::getSpectrum(SoundAnalyzer& soundAnalyzer)
{
	//FMod variable
...
void AnalyzerTool::ExtractRange(const SoundAnalyzer& analyzer, SpectrumData& outRangedSpectrum)
{
	analyzer.data.SpectrumData.
	for (int i = analyzer.GetFrequencyRangeStart(); i)
}

void AnalyzerTool::GetAverageAmplitudeOnRange(const SoundAnalyzer& analyzer)
{
